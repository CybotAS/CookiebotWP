			...
			<div class="cb-main__dashboard__card--container">
				...
				<div class="cb-main__dashboard__card">
					<div class="cb-main__card__inner  <?php echo $cbid ? 'start_card' : 'new_card'; ?>">
						...
						<a href="https://wordpress.org/support/plugin/cookiebot/reviews/#new-post" target="_blank" class="cb-btn cb-link-btn" rel="noopener"><?php echo esc_html__( 'Write a review', 'cookiebot' ); ?></a>
					</div>
				</div>
				<?php endif; ?>
					...
					<div class="cb-main__card__inner  <?php echo $cbid ? 'start_card' : 'new_card'; ?>">
						<?php if ( ! $cbid ) : ?>
							<div class="cb-main__card__content">
								...
								<a href="https://manage.cookiebot.com/en/signup/?utm_source=wordpress&utm_medium=organic&utm_campaign=banner" target="_blank" class="cb-btn cb-white-btn" rel="noopener"><?php echo esc_html__( 'Create a new account', 'cookiebot' ); ?></a>
							</div>
						<?php else : ?>
							...
							<a href="https://support.cookiebot.com/hc/en-us" target="_blank" class="cb-btn cb-link-btn" rel="noopener"><?php echo esc_html__( 'Visit Help Center', 'cookiebot' ); ?></a>
						<?php endif; ?>
					</div>
				</div>
			</div>
				...
				<div class="cb-main__dashboard__card">
					<div class="cb-main__card__inner start_card">
						...
						<div class="cb-main__card--content">
							...
							<a href="https://support.cookiebot.com/hc/en-us/articles/4408356523282-Getting-started" target="_blank" class="cb-btn cb-link-btn" rel="noopener"><?php echo esc_html__( 'Learn more about Cookiebot CMP', 'cookiebot' ); ?></a>
						</div>
					</div>
				</div>
				<div class="cb-main__dashboard__card">
					<div class="cb-main__card__inner legislations_card">
						<div class="cb-main__legislation__item">
							...
							<a href="https://www.cookiebot.com/en/gdpr/" target="_blank" class="cb-btn cb-link-btn external-icon legislation-link" rel="noopener"><?php echo esc_html__( 'Learn More', 'cookiebot' ); ?> <img src="<?php echo esc_html( $link_icon ); ?>" alt="<?php echo esc_html__( 'Learn More', 'cookiebot' ); ?>"></a>
						</div>
						<div class="cb-main__legislation__item">
							...
							<a href="https://www.cookiebot.com/en/what-is-ccpa/" target="_blank" class="cb-btn cb-link-btn external-icon legislation-link" rel="noopener"><?php echo esc_html__( 'Learn More', 'cookiebot' ); ?> <img src="<?php echo esc_html( $link_icon ); ?>" alt="<?php echo esc_html__( 'Learn More', 'cookiebot' ); ?>"></a>
						</div>
						<a href="https://www.cookiebot.com/en/blog/" target="_blank" class="cb-btn cb-link-btn cb-right-btn" rel="noopener"><?php echo esc_html__( 'See other legislations', 'cookiebot' ); ?></a>
					</div>
				</div>
			</div>
		</div>
