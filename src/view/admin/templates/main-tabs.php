...
<div class="cb-main__tabs">
	<?php if ( ! $isnw ) : ?>
		<div class="cb-main__tabs_item <?php echo $active_tab === 'dashboard' ? 'active-item' : ''; ?>">
			<a href="<?php echo admin_url( 'admin.php?page='.esc_html( Dashboard_Page::ADMIN_SLUG ) ); ?>" class="cb-main__tabs__link">
	...
	<div class="cb-main__tabs_item <?php echo $active_tab === 'settings' ? 'active-item' : ''; ?>">
		...
		<?php else : ?>
        <a href="<?php echo admin_url( 'admin.php?page='.esc_html( Settings_Page::ADMIN_SLUG ) ); ?>" class="cb-main__tabs__link">
		<?php endif; ?>
	...
	<?php if ( ! $isnw ) : ?>
		<div class="cb-main__tabs_item <?php echo $active_tab === 'addons' ? 'active-item' : ''; ?>">
			<a href="<?php echo admin_url( 'admin.php?page='.esc_html( Settings_Config::ADMIN_SLUG ) ); ?>" class="cb-main__tabs__link">
	...
	<div class="cb-main__tabs_item <?php echo $active_tab === 'support' ? 'active-item' : ''; ?>">
        ...
        <?php else : ?>
        <a href="<?php echo admin_url( 'admin.php?page='.esc_html( Support_Page::ADMIN_SLUG ) ); ?>" class="cb-main__tabs__link">
        <?php endif; ?>
	...
	<?php if ( ! $isnw ) : ?>
		<div class="cb-main__tabs_item <?php echo $active_tab === 'debug' ? 'active-item' : ''; ?>">
			<a href="<?php echo admin_url( 'admin.php?page='.esc_html( Debug_Page::ADMIN_SLUG ) ); ?>" class="cb-main__tabs__link">
