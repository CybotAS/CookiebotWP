<div class="cb-cbid-subsite-alert__msg hidden">
	...
	<div class="new-account-actions">
		...
		<div id="cookiebot-subsite-cbid-reset" class="cb-btn cb-main-btn">
			<?php esc_html_e( 'Disconnect subsite account', 'cookiebot' ); ?>
		</div>
	</div>
</div>