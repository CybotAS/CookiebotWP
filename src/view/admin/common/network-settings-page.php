			...
			<form method="post" action="edit.php?action=cookiebot_network_settings">
				...
				<div class="cb-settings__tabs__content">
					<div class="cb-settings__tabs__content--item active-item">
                        ...
                        <div>
                            <input type="hidden" name="cookiebot-cookie-blocking-mode" value="<?php echo esc_attr( $cbm ) ?>">
                            <input type="hidden" name="cookiebot-script-tag-uc-attribute" value="<?php echo esc_attr( get_site_option( 'cookiebot-script-tag-uc-attribute', 'custom' ) ) ?>">
                            <input type="hidden" name="cookiebot-script-tag-cd-attribute" value="<?php echo esc_attr( get_site_option( 'cookiebot-script-tag-cd-attribute', 'custom' ) ) ?>">
                            <input type="hidden" name="cookiebot-autoupdate" value="<?php echo esc_attr( get_site_option( 'cookiebot-autoupdate' ) ) ?>">
                            <input type="hidden" name="cookiebot-nooutput" value="<?php echo esc_attr( get_site_option( 'cookiebot-nooutput' ) ) ?>">
                        </div>
					</div>
				</div>
			</form>
