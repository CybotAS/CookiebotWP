		...
		return array(
			...
			'output_schema'       => array(
				...
				'properties'           => array(
					'cbid_set'       => array(
						'type'        => 'boolean',
						'description' => 'Whether a Domain Group ID has been configured.',
					),
					'gcm_enabled'    => array(
						'type'        => 'boolean',
					...
					'blocking_mode'  => array(
						'type'        => 'string',
						'description' => 'Cookie blocking mode: auto or manual.',
					),
					'banner_enabled' => array(
						'type'        => 'boolean',
						'description' => 'Whether the consent banner is enabled.',
					),
