...
Cookiebot CMP version 4.3.10 is out! This release adds new vendor selection options and some content updates. Here is the complete list of this update

####What's new####
* TCF Vendor selection options
* Set WordPress tested up to version to 6.5.5

####Other####
* Removes survey notice
* Video update
