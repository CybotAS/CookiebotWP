...
When doing this you should not add Cookiebot via GTM. If you prefer to do this, you should instead enable the “Hide Cookie Popup” in Cookiebot plugin settings.
