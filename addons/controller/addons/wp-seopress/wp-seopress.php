...
namespace cookiebot_addons\controller\addons\wp_seopress;
...
class Wp_Seopress implements Cookiebot_Addons_Interface {
	...
	public function load_configuration() {
		add_action( 'wp_loaded', array( $this, 'cookiebot_addon_wp_seopress' ), 5 );
	}
	 ...
	 * @since 1.3.0
	 */
	public function cookiebot_addon_wp_seopress() {
		$this->buffer_output->add_tag( 'wp_head', 999, array(
	...
	public function get_extra_information() {
		return '<p>' . esc_html__( 'Blocks cookies from WP SEOPress\' Google Analytics integration.',
				'cookiebot-addons' ) . '</p>';
	}
	 ...
	 * @since 1.8.0
	 */
	public function get_svn_url( $path = 'seopress.php' ) {
		return 'https://plugins.svn.wordpress.org/wp-seopress/trunk/' . $path;
	}
